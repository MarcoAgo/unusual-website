...
import { styledSwitch, styledSwitchButton, styledSwitchCircle } from '@/components/switch/index.style'
...
function Switch(): JSX.Element  {
    ...
    const [themeSignal, setThemeSignal] = createSignal(localStorage.getItem('theme'))
    ...
    const handleSwitchClick = () => {
        const currentTheme = theme.current().current === ThemeType.DARK ? ThemeType.LIGHT : ThemeType.DARK
        gsap.to('#switch-circle', {
            duration: 0.3,
