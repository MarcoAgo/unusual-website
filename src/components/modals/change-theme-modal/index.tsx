...
const ChangeThemeModal: Component<IChangeThemeModalProps> = (
  props
): JSX.Element => {
      ...
      >
        <div class={styledChangeThemeModalContainer} id="change-theme-modal">
          <div class={styledTxtContainer}>
            <h2>Hey!</h2>
            <h3>
              It seems you are using a dark theme on your computer, do you want
              to enable it also for this website?
            </h3>
            <p>
              Don't worry, if you like light theme you can simply close this
              modal :|
            </p>
          </div>
          <div class={styledButtons}>
            <button
              onClick={() => {
                setIsOpen(false)
                sessionStorage.setItem('modal-triggered', 'true')
              }}
            >
              Close
            </button>
